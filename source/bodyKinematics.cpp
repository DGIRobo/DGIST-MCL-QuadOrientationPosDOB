...
void bodyKinematics::state_update(TrunkModel_* trunk_model)
{
    ...
    for (int i = 0; i < NUM_LEG; i++)
    {
        ...
        trunk_model->ctrl_input_RW_from_trunk_old[i] = trunk_model->ctrl_input_RW_from_trunk[i];
    }
};
...
void bodyKinematics::state_init(const mjModel* m, mjData* d, TrunkModel_* trunk_model)
{
    ...
    for (int i = 0; i < NDOF_TRUNK; i++)
    {
        ...
        trunk_model->ctrl_input_RW_from_trunk[i] = 0;
        trunk_model->ctrl_input_RW_from_trunk_old[i] = trunk_model->ctrl_input_RW_from_trunk[i];
    }
    ...
    trunk_model->ctrl_input_RW_from_trunk[3] = 0;
    trunk_model->ctrl_input_RW_from_trunk_old[3] = trunk_model->ctrl_input_RW_from_trunk[3];
};
